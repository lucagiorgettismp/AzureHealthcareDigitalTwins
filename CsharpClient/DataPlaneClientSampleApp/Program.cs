...
namespace DataPlaneSampleApp
{
    public sealed class Program
    {
        ...
        private const string MicrosoftTenantId = "e99647dc-1b08-454a-bf8c-699181b389ab";
        ...
        private const string EnvironmentFqdn = "4d3d9072-f30a-4474-9964-54f6d194da93.env.timeseries.azure.com";

        // Select a timeSeriesId from the environment.
        private static readonly object[] TimeSeriesId = { "LorenzoVitalSignsMonitor" };

        // Select a search span for the query.
        private static readonly DateTimeRange SearchSpan = new DateTimeRange(new DateTime(2020, 01, 01).ToUniversalTime(), new DateTime(2023, 02, 02).ToUniversalTime());
                        ...
                        getSeries: new GetSeries(
                            ...
                            inlineVariables: new Dictionary<string, Variable>()
                            {
                                ["value"] = new NumericVariable(
                                    filter: null,
                                    value: new Tsx("$event['battery.value'].Long"),
                                    aggregation: new Tsx("avg($value)")
                                    ),
